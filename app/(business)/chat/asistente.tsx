...
export default function BusinessAiAssistantScreen() {
  ...
  function handleAction(message: AiChatMessage) {
    ...
    resolveAiChatAction(message.action, { router, role: 'business' });
  }
        ...
        >
          {messages.length === 0 ? (
            <Text style={styles.placeholder}>
              Hola, soy el asistente de SOSmoto para tu negocio. Pregúntame sobre tus métricas, reseñas, publicidad, o
