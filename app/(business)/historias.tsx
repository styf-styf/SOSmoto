...
import { createStory, deleteStory, getBusinessStories } from '../../services/stories';
...
function isVisible(story: Story): boolean {
...
export default function HistoriasScreen() {
  ...
  const activeCount = stories.filter(isVisible).length;
          ...
          <View key={story.id} style={styles.storyCard}>
            ...
            <View style={styles.storyInfo}>
              ...
              <Text style={styles.cardMeta}>
                {isVisible(story) ? (story.is_pinned ? 'Destacada' : 'Activa') : 'Expirada'}
                {' · '}
