...
function createStyles(colors: ColorTheme) {
  return StyleSheet.create({
    ...
    vehicleChipSelected: { borderColor: colors.primary, backgroundColor: colors.warningLight },
    ...
    draftLoadedBanner: {
      ...
      backgroundColor: colors.infoLight, borderWidth: 1, borderColor: colors.info,
