...
// Composer rápido sobre el feed de Inicio (debajo de Historias) -- todo en
// una sola fila (foto, etiqueta, texto, enviar) igual que el input de Chat,
// para que ocupe lo mínimo cuando no se está usando. Lo que necesita más
// espacio (preview de imagen, buscador de etiqueta) se despliega debajo.
